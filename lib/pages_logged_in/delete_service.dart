                                    ...
                                    onPressed: () async {
                                      ...
                                      while(serviceIndex < snapshot.data['$currentShopIndex']['services-amount']){
                                        ...
                                        if(selectedIdx != serviceIndex){
                                          ...
                                          String serviceMaxAmountOfBookings = snapshot.data['$currentShopIndex']['services']['$serviceIndex']['max-amount-per-timing'];
                                          ...
                                          dynamic serviceTimings = snapshot.data['$currentShopIndex']['services']['$serviceIndex']['service-timings'];
